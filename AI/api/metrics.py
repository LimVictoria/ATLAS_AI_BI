...
METRICS = {
    ...
    "total_cost": {
        ...
        "expr":        "ROUND(SUM(total_cost_myr), 2)",
        "category":    "Cost",
        "unit":        "MYR",
        "description": "Total cost across all maintenance events",
    },
    "total_parts_cost": {
        "name":        "Total Parts Cost",
        "expr":        "ROUND(SUM(parts_cost_myr), 2)",
        "category":    "Cost",
        "unit":        "MYR",
        "description": "Total spend on parts and materials",
    },
    "total_labour_cost": {
        "name":        "Total Labour Cost",
        "expr":        "ROUND(SUM(labour_cost_myr), 2)",
        "category":    "Cost",
        "unit":        "MYR",
        "description": "Total spend on labour",
    },
    "avg_cost_per_event": {
        "name":        "Average Cost per Event",
        "expr":        "ROUND(AVG(total_cost_myr), 2)",
        "category":    "Cost",
        "unit":        "MYR",
        "description": "Average maintenance cost per event",
    },
    "cost_per_km": {
        "name":        "Cost per KM",
        ...
        "category":    "Cost",
        "unit":        "MYR/km",
        "description": "Maintenance cost per kilometre driven",
    },
    ...
    "warranty_recovery_rate": {
        ...
        "category":    "Cost",
        "unit":        "%",
        "description": "Percentage of total cost covered by warranty",
    },
    "warranty_recovered_amount": {
        ...
        "category":    "Cost",
        "unit":        "MYR",
        "description": "Absolute cost recovered through warranty claims",
    },

    # ── DOWNTIME ──────────────────────────────────────────────────────────────
    "total_downtime": {
        "name":        "Total Downtime Hours",
        "expr":        "ROUND(SUM(downtime_hours), 2)",
        "category":    "Downtime",
        "unit":        "hours",
        "description": "Total hours vehicles were out of service",
    },
    "avg_downtime_per_event": {
        "name":        "Average Downtime per Event",
        "expr":        "ROUND(AVG(downtime_hours), 2)",
        "category":    "Downtime",
        "unit":        "hours",
        "description": "Average downtime hours per maintenance event",
    },
    "total_labour_hours": {
        "name":        "Total Labour Hours",
        "expr":        "ROUND(SUM(labour_hours), 2)",
        "category":    "Downtime",
        "unit":        "hours",
        "description": "Total technician hours spent on maintenance",
    },
    "avg_labour_hours_per_event": {
        "name":        "Average Labour Hours per Event",
        "expr":        "ROUND(AVG(labour_hours), 2)",
        "category":    "Downtime",
        "unit":        "hours",
        "description": "Average technician hours per maintenance event",
    },
    "downtime_cost_rate": {
        ...
        "category":    "Downtime",
        "unit":        "MYR/hour",
        "description": "Maintenance cost per hour of vehicle downtime",
    },

    # ── RELIABILITY ───────────────────────────────────────────────────────────
    "total_events": {
        "name":        "Total Maintenance Events",
        "expr":        "COUNT(*)",
    ...
    "unscheduled_rate": {
        ...
        "category":    "Reliability",
        "unit":        "%",
        "description": "Percentage of maintenance events that were unscheduled",
    },
    "corrective_rate": {
        ...
        "category":    "Reliability",
        "unit":        "%",
        "description": "Percentage of events that were corrective maintenance",
    },
    "scheduled_pm_rate": {
        ...
        "category":    "Reliability",
        "unit":        "%",
        "description": "Percentage of events that were scheduled preventive maintenance",
    },
    "emergency_rate": {
        ...
        "category":    "Reliability",
        "unit":        "%",
        "description": "Percentage of events that were emergency maintenance",
    },
    "critical_event_rate": {
        ...
        "category":    "Reliability",
        "unit":        "%",
        "description": "Percentage of maintenance events rated as critical severity",
    },
    "mtbf": {
    ...
    "avg_mileage_at_event": {
        "name":        "Average Mileage at Event",
        "expr":        "ROUND(AVG(current_mileage_km), 0)",
        "category":    "Utilisation",
        "unit":        "km",
        "description": "Average vehicle mileage when maintenance event occurs",
    },
    "avg_technician_count": {
        "name":        "Average Technician Count",
        "expr":        "ROUND(AVG(technician_count), 1)",
        "category":    "Utilisation",
        "unit":        "count",
...
def get_metrics_guide() -> str:
    ...
    lines = [
        "",
        "PREDEFINED METRICS — always use these exact formulas, never improvise:",
        "",
    ]
    ...
    lines += [
        ...
        "  - Add GROUP BY and ORDER BY as needed for the requested dimension",
        "  - WHERE is added separately — never hardcode it in the metric expr",
        "",
        "EXAMPLES:",
        ...
        "",
        "  'warranty recovery rate by brand and year'",
        "    -> SELECT brand, year,",
        "            ROUND(SUM(CASE WHEN warranty_covered = true THEN total_cost_myr ELSE 0 END) / NULLIF(SUM(total_cost_myr), 0) * 100, 2) AS warranty_recovery_rate",
        "       FROM v_maintenance_full GROUP BY brand, year ORDER BY brand, year",
    ]
...
@router.get("/")
def get_all_metrics():
    """Return all predefined metrics."""
    return {"metrics": METRICS}


@router.get("/{metric_key}")
def get_metric(metric_key: str):
    """Return a specific metric by key."""
